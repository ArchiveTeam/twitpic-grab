...
### For Debian/Ubuntu:
    ...
    pip install seesaw
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/twitpic-grab.git; cd twitpic-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/twitpic-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, twitpic-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/twitpic-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
