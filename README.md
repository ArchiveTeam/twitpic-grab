...
Alternativly, you can to downgrade the version of Perl running on your system. Version 5.16.0 should do the trick. Use these commands to install and switch to the appropriate version:
...
And then try running "./get-wget-lua.sh" again.
